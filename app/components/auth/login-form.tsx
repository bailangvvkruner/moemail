...
export function LoginForm({ turnstile, oauthProviders }: LoginFormProps) {
  ...
  const hasOAuthProviders = Boolean(oauthProviders?.github || oauthProviders?.google)
  ...
  const validateLoginForm = () => {
    ...
    if (password.length > 128) newErrors.password = t("errors.passwordTooLong")
    setErrors(newErrors)
